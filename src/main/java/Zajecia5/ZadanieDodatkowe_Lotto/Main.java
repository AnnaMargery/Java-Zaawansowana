package Zajecia5.ZadanieDodatkowe_Lotto;
...
//        Zadbaj o odpowiedni dostęp do informacji o ostatnim losowaniu. Dodaj getter metodę o wygrywająych liczbach zwracającą niemodyfikowalną listę (List.of()).
